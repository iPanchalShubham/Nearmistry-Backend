...
export const fetchUsers = (page,filterVars) => axios.get(url+`volunteerSection/homePage?page=${page}&helper=${filterVars.helper}&raj_mistri=${filterVars.raj_mistri}&labour=${filterVars.labour}&painter=${filterVars.painter}&welder=${filterVars.welder}`)
